        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <p className="text-xl text-gray-600 max-w-lg leading-relaxed">
              Apoie organizações que transformam vidas. Com transparência, impacto real e muito amor.
            </p>

            <div className="flex flex-col sm:flex-row gap-4">
              <button 
                onClick={() => setCurrentView(View.MARKETPLACE)}
                className="px-8 py-4 bg-brand-blue text-white rounded-xl font-bold text-lg shadow-xl hover:shadow-brand-blue/30 transition-all flex items-center justify-center gap-2 group"
              >
