...
export const demoNgos: NGO[] = [
  {
    ...
    goal: "Criar rodas de conversa semanais e oferecer 200 atendimentos de escuta qualificada por mês.",
    ...
    posts: [
      {
        ...
        type: "image",
        caption:
          "Encontro aberto com voluntários e participantes da comunidade.",
  ...
  },
  {
    ...
    category: "Social",
    goal: "Montar kits de cuidado e ampliar as oficinas para três bairros nos próximos meses.",
    ...
    posts: [
      {
        ...
        type: "image",
        caption:
          "Uma tarde de orientação, escuta e vínculos com as famílias atendidas.",
  ...
  },
  {
    ...
    description:
      "Resgate e adoção de gatos, com feiras de adoção e campanhas de castração.",
    category: "Pets",
  ...
  },
  {
    ...
    name: "Abrigo Peludo",
    description:
      "Cuidado e acolhimento de cães idosos e com deficiência até a adoção definitiva.",
    category: "Pets",
  ...
  },
  {
    ...
    name: "Rio Limpo",
    description:
      "Mutirões de despoluição de rios e nascentes com comunidades ribeirinhas.",
    category: "Meio Ambiente",
  ...
  },
  {
    ...
    description:
      "Educação ambiental e hortas em escolas para crianças e adolescentes.",
    category: "Educação",
    ...
    posts: [
      {
        ...
        type: "image",
        caption:
          "Orientação preventiva e cuidado chegando perto de quem precisa.",
